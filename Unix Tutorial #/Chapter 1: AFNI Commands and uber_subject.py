...
If uber_subject.py isn’t working, you can download the output script here. This will run both preprocessing and regression.

AFNI Commands
AFNI commands are similar to Unix commands: They typically require at least one argument, or input, and they also usually require you to specify what to call the output of the command.
...
../../../_images/01_SkullStripErrorMessage.png
...
../../../_images/04_01_AFNI_HelpFile.gif
...
../../../_images/04_01_SkullStrip_overlay.png
...
../../../_images/04_01_uber_subject_GUI.png
...
Exercises
Use either the -no_avoid_eyes or -use_skull options with 3dSkullStrip. Look at the help file to learn about what they do, and predict how it would affect your skull strip. Does your prediction match what you see in the output?
Load an anatomical image into the AFNI viewer and press the “Graph” button. How is it different from when you looked at the “Graph” output with a functional image? Why?
Video
For an overview of AFNI commands using 3dSkullStrip as an example, click here.
